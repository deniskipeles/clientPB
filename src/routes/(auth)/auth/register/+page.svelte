...
<div class="text-center">
  <Card>
  	...
  	>
  		<h3 class="text-xl font-medium text-gray-900 dark:text-white p-0">Create Your Account{data.authTables.length > 1 ?" As:":":"}</h3>
  		...
  		{/if}
    	<Auth2 {authData} auth_collection={group} head={"Register"}/>
