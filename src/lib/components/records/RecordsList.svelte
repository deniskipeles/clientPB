<script>
	...
	import { addSuccessToast } from '$lib/stores/toasts';
	// import { collections } from "$lib/stores/collections";
	import SortHeader from '$lib/components/base/SortHeader.svelte';
	...
	async function deleteSelected() {
		...
		for (const recordId of Object.keys(bulkSelected)) {
			promises.push(ApiClient.collection(collectionUpsert.id).delete(recordId));
		}
